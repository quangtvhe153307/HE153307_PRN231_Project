...
namespace APIProject.ZaloPay.Models
{
    public class OrderData
    {
        ...
        {
            Appid = ConfigurationUtils.Configuration["ZaloPayConfig:Appid"];
        ...
        {
            return HmacHelper.Compute(ZaloPayHMAC.HMACSHA256, ConfigurationUtils.Configuration["ZaloPayConfig:Key1"], GetMacData());
        }
    }
    ...
    //    {
    //        Paymentcode = RSAHelper.Encrypt(paymentcodeRaw, ConfigurationUtils.main.Configuration["ZaloPayConfig:RSAPublicKey"]);
    //        Mac = ComputeMac();
    //    }
